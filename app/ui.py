...
"}")
        ...
        self.mainBlockRpmFrame.setGeometry(QRect(0, 44, 195, 90))
        self.mainBlockRpmFrame.setMinimumSize(QSize(195, 0))
        ...
        self.configComboBox.setFont(font2)
        ...
        self.coefficientsLabel.setGeometry(QRect(13, 13, 211, 17))
        font4 = QFont()
        ...
        self.coefficientLabel1.setFont(font1)
        ...
        self.coefficientLabel3.setFont(font1)
        ...
        self.coefficientLabel2.setFont(font1)
        ...
        self.coefficientLabel4.setFont(font1)
        ...
        self.rpmPerSensorLabel.setGeometry(QRect(13, 13, 131, 17))
        ...
        self.sensorRpmLabel1.setFont(font1)
        ...
        self.sensorRpmLabel3.setFont(font1)
        ...
        self.sensorRpmLabel2.setFont(font1)
        ...
        self.sensorRpmLabel4.setFont(font1)
        ...
        self.manualRpmCheckBox.setGeometry(QRect(150, 20, 85, 20))
        self.mainBlockLabel = QLabel(self.mainFrame)
        self.mainBlockLabel.setObjectName(u"mainBlockLabel")
        self.mainBlockLabel.setGeometry(QRect(10, 20, 111, 17))
        self.mainBlockLabel.setFont(font4)
        self.resetConfigBtn = QPushButton(self.mainFrame)
        self.resetConfigBtn.setObjectName(u"resetConfigBtn")
        self.resetConfigBtn.setGeometry(QRect(140, 15, 80, 30))
        sizePolicy.setHeightForWidth(self.resetConfigBtn.sizePolicy().hasHeightForWidth())
        self.resetConfigBtn.setSizePolicy(sizePolicy)
        self.resetConfigBtn.setMinimumSize(QSize(80, 30))
        self.resetConfigBtn.setMaximumSize(QSize(80, 30))
        font5 = QFont()
        font5.setPointSize(10)
        font5.setBold(True)
        self.resetConfigBtn.setFont(font5)
        self.resetConfigBtn.setStyleSheet(u"")
        self.resetConfigBtn.setCheckable(False)
        self.resetConfigBtn.setFlat(False)
        ...
        self.clearConsoleBtn = QPushButton(self.commandButtonsFrame)
        self.clearConsoleBtn.setObjectName(u"clearConsoleBtn")
        sizePolicy.setHeightForWidth(self.clearConsoleBtn.sizePolicy().hasHeightForWidth())
        self.clearConsoleBtn.setSizePolicy(sizePolicy)
        self.clearConsoleBtn.setMinimumSize(QSize(40, 40))
        self.clearConsoleBtn.setMaximumSize(QSize(50, 50))
        self.clearConsoleBtn.setFont(font1)
        self.clearConsoleBtn.setStyleSheet(u"")
        self.clearConsoleBtn.setCheckable(False)
        self.clearConsoleBtn.setFlat(False)

        self.horizontalLayout_2.addWidget(self.clearConsoleBtn)
        ...
        self.simulationBtn.setMinimumSize(QSize(180, 40))
        ...
        self.controlS1Btn.setMinimumSize(QSize(95, 40))
        self.controlS1Btn.setMaximumSize(QSize(92, 50))
        self.controlS1Btn.setFont(font1)
        ...
        self.controlS2Btn.setMinimumSize(QSize(95, 40))
        self.controlS2Btn.setMaximumSize(QSize(92, 50))
        self.controlS2Btn.setFont(font1)
        ...
        self.controlS3Btn.setMinimumSize(QSize(95, 40))
        self.controlS3Btn.setMaximumSize(QSize(92, 50))
        self.controlS3Btn.setFont(font1)
        ...
        self.controlS4Btn.setMinimumSize(QSize(95, 40))
        self.controlS4Btn.setMaximumSize(QSize(92, 50))
        self.controlS4Btn.setFont(font1)
        ...
        font6 = QFont()
        font6.setFamilies([u"Courier New"])
        font6.setPointSize(10)
        self.consoleText.setFont(font6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.resetConfigBtn.setText(QCoreApplication.translate("MainWindow", u"\U0001f504 Reset", None))
#if QT_CONFIG(tooltip)
        self.clearConsoleBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Clear console", None))
#endif // QT_CONFIG(tooltip)
        self.clearConsoleBtn.setText(QCoreApplication.translate("MainWindow", u"\U0001f191", None))
